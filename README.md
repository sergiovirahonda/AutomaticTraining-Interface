...
IMAGE_REPO_NAME=interface_automatic_training
IMAGE_TAG=cpu
IMAGE_URI=gcr.io/$PROJECT_ID/$IMAGE_REPO_NAME:$IMAGE_TAG

MODEL_DIR=interface_automatic_training_$(date +%Y%m%d_%H%M%S)
JOB_NAME=interface_automatic_training_job_$(date +%Y%m%d_%H%M%S)
